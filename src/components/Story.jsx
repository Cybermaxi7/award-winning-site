        ...
        >
            <div className="flex size-full flex-col items-center py-10 pb-24">
                ...
                <div className="relative size-full">
                    <AnimatedTitle
                        title={
                            "The st<b>o</b>ry of <br /> <b>a</b> hidden real<b>m</b>"
                        }
                        sectionId={"#story"}
                        containerClass={
                ...
                <div
                    className={
                        " -mt-80 md:-mt-64 md:me-44 flex w-full justify-center md:justify-end"
                    }
                >
                    <div className="flex h-full w-fit flex-col items-center md:items-start">
                        ...
                        >
                            ...
                            pillar. Discover it's secret and shape your faith
