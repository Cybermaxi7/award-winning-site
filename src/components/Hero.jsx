...
export default function Hero() {
    ...
    const upcomingVideosRef = (currentIndex % totalVideos) + 1;
        ...
        <div className={"relative h-dvh w-screen overflow-x-hidden"}>
            ...
            >
                <div>
                    <div
                        className={
                            "mask-clip-path absolute-center z-50 size-54 cursor-pointer overflow-hidden"
                        }
                    >
                        <div
                        ...
                        >
                            <video
                                ref={nextVideoRef}
                                src={getVideoSource(upcomingVideosRef)}
                                loop
                                muted
                                id="current-video"
                                className={
                    ...
                    <video
                        ...
                        muted
                        className={
                            "absolute top-0 left-0 size-full object-cover object-center"
                        }
                        onLoadedData={handleVideoLoad}
                    />
                </div>
